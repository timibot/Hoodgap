...
async function fetchTeslaPrice() {
  try {
    ...
    console.warn("⚠ Could not fetch live TSLA price, using fallback");
  }
  return 350.0;
}
...
async function main() {
  ...
  // Ensure week timing is set correctly from deployment
  const timingTx = await hoodgap.updateWeekTiming();
  await timingTx.wait();
  console.log("✅ Week timing initialized");

  // Auto-write frontend/.env.local
  const envContent = [
    "# HoodGap Frontend Environment — auto-generated by deploy.js",
  ...
  console.log("\n✅ Auto-wrote frontend/.env.local");

  console.log("\n📋 Summary:");
  console.log("   USDC:    ", usdcAddress);
  console.log("   Oracle:  ", oracleAddress);
  console.log("   HoodGap: ", hoodgapAddress);
  console.log("\n🎯 Next: restart `npm run dev` in frontend/");
}
